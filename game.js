...
const stoneMat = material(
  0x59616b,
  0.9
);

const darkStoneMat = material(
  0x303841,
  0.95
);
...
const woodMat = material(
  0x4b2f20,
  0.85
);

const woodDarkMat = material(
  0x281812,
  0.9
);

const grassMat = material(
  0x40583c,
  1
);

const pathMat = material(
  0x77786f,
  1
);
